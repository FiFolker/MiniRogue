...
enum Direction {
	...
	/**
	 * Renvoie le nombre de cases parcourues horizontalement lorsqu'on suit cette direction (0 pour Nord et Sud, -1 pour
	 * Ouest, 1 pour Est).
	 *
	...
	/**
	 * Renvoie le nombre de cases parcourues verticalement lorsqu'on suit cette direction (0 pour Est et Ouest, -1 pour
	 * Nord, 1 pour Sud).
	 *
